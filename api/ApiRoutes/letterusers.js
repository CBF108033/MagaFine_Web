...
import { deleteLetterUser, getAllLetterUsers, getLetterUser, getLetterUserInfo, updatedLetterUserInfo } from "../RoutesController/letterusers.js";
...
router.put("/:userID", verifyUser, updatedLetterUserInfo)//更新用戶資料，需驗證
