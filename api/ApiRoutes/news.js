...
import { createNews, deleteNews, getNews, updatedNews, getAllNews, getUserNews } from "../RoutesController/news.js";
...
router.get("/myself/:userID", verifyUser, getUserNews)//取得該作者的全部News，需驗證
